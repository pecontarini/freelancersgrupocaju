...
const PRIORIDADE_MAP: Record<MissaoPrioridade, { label: string; cls: string }> = {
  alta: { label: "ALTA", cls: "bg-destructive/10 text-destructive border-destructive/30" },
  media: { label: "MÉDIA", cls: "bg-amber-500/10 text-amber-700 border-amber-500/30 dark:text-amber-400" },
  baixa: { label: "BAIXA", cls: "bg-emerald-500/10 text-emerald-700 border-emerald-500/30 dark:text-emerald-400" },
};
