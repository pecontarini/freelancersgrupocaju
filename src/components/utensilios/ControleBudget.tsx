  ...
  const handleGerarPedido = () => {
    ...
    const pedidos = allocations
      ...
      .map((a) => ({
        ...
        config_id: config.id,
        qtd_deficit: a.deficit,
        qtd_aprovada: a.qtdAprovada,
        valor_unitario: a.unitCost,
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <Button onClick={handleGerarPedido} disabled={!semanaRef || !config || createPedido.isPending}>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right">Qtd Aprov.</TableHead>
