...
export function RankingView() {
  ...
  const rows = useMemo(() => {
    ...
    const sorted = [...LOJAS_MOCK].sort((a, b) => {
      const av = a.values[metric];
      const bv = b.values[metric];
    ...
    <Card className="vision-glass">
      ...
      <CardContent>
        ...
        <p className="mt-3 text-[11px] text-muted-foreground">
          Dados de demonstração · integração com base oficial em desenvolvimento.
        </p>
      </CardContent>
    </Card>
  );
